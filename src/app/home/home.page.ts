...
@Component({
  ...
  standalone: true,
  imports: [IonButton, IonHeader, IonToolbar, IonTitle, IonContent, LoaderComponent],
...
export class HomePage {
  ...
  series1 = [
    { src: 'assets/img/series1/image1.jpg', text: "test for image 1"},
  ...
  showLoader() {
    ...
    }, 10000); // 10 segundos simulando la llamada al proceso o API
  }
}
